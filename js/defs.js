...
function def(o){return Object.assign({size:1,itemCap:10,liqCap:60,powerUse:0,powerGen:0,directional:false,category:'factory',desc:''},o)}
const BUILDING_DEFS={
  ...
  [BTYPE.CONTAINER]:def({name:'Контейнер',size:2,color:'#7a6a5a',itemCap:80,category:'transport',desc:'Склад 2x2, 80 предметов'}),
  [BTYPE.VAULT]:def({name:'Хранилище',size:3,color:'#6a5a4a',itemCap:300,category:'transport',desc:'Склад 3x3, 300 предметов'}),
  ...
  [BTYPE.PNEU_DRILL]:def({name:'Пневм. бур',size:2,color:'#6a8a9a',itemCap:10,liqCap:35,category:'drill',mine:{sand:.6,copper:.53,lead:.53,coal:.48,titanium:.43},boostWater:5,boostMul:2.56,desc:'2x2. Без энергии'}),
  [BTYPE.LASER_DRILL]:def({name:'Лазер. бур',size:3,color:'#6a90b0',itemCap:20,liqCap:40,powerUse:66,category:'drill',mine:{sand:1.0,copper:.9,lead:.9,coal:.8,titanium:.7,thorium:.6},boostWater:6,boostMul:2.56,desc:'3x3. 66 э/с'}),
  [BTYPE.AIRBLAST_DRILL]:def({name:'Воздуш. бур',size:4,color:'#5a80a0',itemCap:30,liqCap:50,powerUse:180,category:'drill',mine:{sand:1.6,copper:1.4,lead:1.4,coal:1.2,titanium:1.0,thorium:.85},boostWater:8,boostMul:3.24,desc:'4x4. 180 э/с'}),
  [BTYPE.CONDUIT]:def({name:'Трубопровод',size:1,color:'#4a90d0',directional:false,category:'liquid',desc:'Труба'}),
  [BTYPE.PULSE_CONDUIT]:def({name:'Имп. трубопровод',size:1,color:'#6ab0ff',directional:false,category:'liquid',desc:'Быстрая труба'}),
  ...
  [BTYPE.MECH_PUMP]:def({name:'Мех. помпа',size:1,color:'#4a80b0',liqCap:40,pumpRate:7,category:'liquid',desc:'7 воды/с'}),
  [BTYPE.ROTARY_PUMP]:def({name:'Ротор. помпа',size:2,color:'#5a90c0',liqCap:80,powerUse:12,pumpRate:48,category:'liquid',desc:'48 воды/с'}),
  ...
  [BTYPE.GRAPHITE_PRESS]:def({name:'Графит. пресс',size:2,color:'#707070',itemCap:10,category:'factory',recipe:{in:{coal:2},out:{graphite:1},time:1.5},desc:'2 угля → графит'}),
  [BTYPE.MULTI_PRESS]:def({name:'Улучш. пресс',size:3,color:'#606060',liqCap:60,itemCap:20,powerUse:108,category:'factory',recipe:{in:{coal:3,water:6},out:{graphite:2},time:.5},desc:'3у+6в → 2 графита'}),
  [BTYPE.SILICON_SMELTER]:def({name:'Кремн. плавильня',size:2,color:'#a0a0b0',itemCap:10,powerUse:30,category:'factory',recipe:{in:{coal:1,sand:2},out:{silicon:1},time:.666},desc:'уголь+песок → кремний'}),
  [BTYPE.SILICON_CRUCIBLE]:def({name:'Кремн. тигель',size:3,color:'#9090a0',itemCap:30,powerUse:240,category:'factory',recipe:{in:{coal:4,sand:6,pyratite:1},out:{silicon:8},time:5.333},desc:'→ 8 кремния'}),
  [BTYPE.KILN]:def({name:'Печь',size:2,color:'#c08040',itemCap:10,powerUse:36,category:'factory',recipe:{in:{lead:1,sand:1},out:{metaglass:1},time:.5},desc:'свинец+песок → метастекло'}),
  [BTYPE.PLASTANIUM_COMPRESSOR]:def({name:'Пластан. компрессор',size:2,color:'#80c060',liqCap:60,itemCap:10,powerUse:180,category:'factory',recipe:{in:{oil:15,titanium:2},out:{plastanium:1},time:1},desc:'нефть+титан → пластан'}),
  [BTYPE.PHASE_WEAVER]:def({name:'Фазовый ткач',size:2,color:'#b080e0',itemCap:10,powerUse:300,category:'factory',recipe:{in:{thorium:4,sand:10},out:{phase:1},time:2},desc:'торий+песок → фаза'}),
  [BTYPE.SURGE_SMELTER]:def({name:'Плавильня кинет.',size:3,color:'#e0c040',itemCap:20,powerUse:240,category:'factory',recipe:{in:{copper:3,lead:4,titanium:2,silicon:3},out:{surge:1},time:1.25},desc:'→ кинет. сплав'}),
  [BTYPE.CRYOFLUID_MIXER]:def({name:'Мешалка крио',size:2,color:'#60d0e0',liqCap:36,itemCap:10,powerUse:60,category:'factory',recipe:{in:{titanium:1,water:12},out:{cryo:12},time:2},desc:'титан+вода → крио'}),
  [BTYPE.PYRATITE_MIXER]:def({name:'Мешалка пиротита',size:2,color:'#e06040',itemCap:10,powerUse:12,category:'factory',recipe:{in:{coal:1,lead:2,sand:2},out:{pyratite:1},time:.75},desc:'→ пиротит'}),
  [BTYPE.BLAST_MIXER]:def({name:'Мешалка взрывн.',size:2,color:'#e04060',itemCap:10,powerUse:24,category:'factory',recipe:{in:{pyratite:1,spore:1},out:{blast:1},time:.75},desc:'→ взрывная смесь'}),
  [BTYPE.MELTER]:def({name:'Плавильня',size:1,color:'#ff8040',liqCap:10,itemCap:10,powerUse:60,category:'factory',recipe:{in:{metalom:1},out:{slag:12},time:.166},desc:'металлом → шлак'}),
  [BTYPE.SEPARATOR]:def({name:'Отделитель',size:2,color:'#a08060',liqCap:40,powerUse:66,category:'factory',desc:'шлак → ресурсы'}),
  [BTYPE.DISASSEMBLER]:def({name:'Разборщик',size:3,color:'#908070',liqCap:72,itemCap:20,powerUse:240,category:'factory',desc:'металлом+шлак → ресурсы'}),
  [BTYPE.SPORE_PRESS]:def({name:'Споровый пресс',size:2,color:'#60a040',liqCap:60,powerUse:42,category:'factory',recipe:{in:{spore:1},out:{oil:18},time:.333},desc:'спора → нефть'}),
  [BTYPE.PULVERIZER]:def({name:'Измельчитель',size:1,color:'#a09070',itemCap:10,powerUse:30,category:'factory',recipe:{in:{metalom:1},out:{sand:1},time:.666},desc:'металлом → песок'}),
  [BTYPE.COAL_CENTRIFUGE]:def({name:'Угольн. центриф.',size:2,color:'#505050',liqCap:60,powerUse:42,category:'factory',recipe:{in:{oil:6},out:{coal:1},time:.5},desc:'нефть → уголь'}),
  [BTYPE.INCINERATOR]:def({name:'Мусоросжигатель',size:1,color:'#404040',powerUse:30,category:'factory',desc:'Уничтожает'})
};
const CAT_MAP={factory:[],units:[],logic:[],power:[],walls:[],transport:[],liquid:[],drill:[],util:[],turret:[]};
...
const CATEGORIES=[
  ...
  {id:'logic',name:'Логика',side:'right',row:3,blocks:CAT_MAP.logic}
];
